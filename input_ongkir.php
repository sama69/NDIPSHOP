			...
			<form action="aksi_ongkir.php" method="POST">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Nama Kota" name="nama_kota">
                </div>
                <!-- /.input group -->
              </div>
			  <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Ongkos Kirim" name="ongkos_kirim">
                </div>
                <!-- /.input group -->
              </div>
			  <div class="col-xs-2">
